...
[**`examples/simple/main.py`**](https://github.com/RedTeam/rest.vm-runner/blob/main/examples/simple/main.py):
...
[**`examples/async/main.py`**](https://github.com/RedTeam/rest.vm-runner/blob/main/examples/async/main.py):
