...
```sh
git clone https://github.com/RedTeam/rest.vm-runner.git && \
    cd rest.vm-runner
```
...
1. Download archived **zip** or **tar.gz** file from [**releases**](https://github.com/RedTeam/rest.vm-runner/releases).
